...
https://www.youtube.com/watch?v=b3X3tgHHzyw
...
![image-20210513100909614](https://raw.githubusercontent.com/yusenyi123/pictures2/master/imgs/20210513100909.png)

### 2.选择代理模式

![image-20210512205316808](https://raw.githubusercontent.com/yusenyi123/pictures2/master/imgs/20210512205316.png)

### 3.启动clash代理

![image-20210512205648395](https://raw.githubusercontent.com/yusenyi123/pictures2/master/imgs/20210512205648.png)
...
![image-20210513093323389](https://raw.githubusercontent.com/yusenyi123/pictures2/master/imgs/20210513093330.png)
...
dns:
  ...
  # 以下填写的 DNS 服务器将会被用来解析 DNS 服务的域名(default-nameserver填写的dns服务器会解析nameserver中填写的是域名的dns服务器)
  # 仅填写 DNS 服务器的 IP 地址
  default-nameserver:
    - 223.5.5.5
    - 114.114.114.114
  ...
  # nameserver 下填写的dns服务器会解析我们进行网页浏览等操作时需要解析的域名
  nameserver:
...
## windows的clash配置文件位于`C:\Users\当前登录用户\.config\clash`
